...
/* ════════════════════════════════════════════════════════════════
   OAUTH
════════════════════════════════════════════════════════════════ */
function handleGoogleLogin() { window.location.href = `${API_BASE}/oauth2/authorization/google`; }
function handleGithubLogin() { window.location.href = `${API_BASE}/oauth2/authorization/github`; }
